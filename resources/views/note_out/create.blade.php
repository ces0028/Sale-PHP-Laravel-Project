...
@section('content')
  ...
  <div class="alert mycolor1 mt-2" role="alert">매출</div>
    ...
    <form name="form1" method="post" action="{{route('note_out.store')}}{{$tmp}}" enctype="multipart/form-data">
    @csrf
        <table class="table table-bordered table-sm mymargin5">
          ...
          <tr>
            ...
            <td width="80%" align="left">
                <div class="d-inline-flex">
                    <input type="text" name="num_out" size="20" maxlength="20" value="{{old('num_out')}}" class="form-control form-control-sm" onchange="cal_total_price()">
                </div>
            </td>
          </tr>
          <tr>
